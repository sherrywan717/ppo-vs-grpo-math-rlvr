...
- Execution base HEAD `3bd7f62d6d83d06c805d924cb1f7739e560e3f93` was clean; frozen model, suite, evaluation, checkpoint, and baseline identities passed.
- `ppo_final_formal_1p5b_seed42_20260720T052931Z` was externally terminated by a host power/network outage at 429/800 rows and 41,144 tokens. Its rows are immutable and excluded; no resume, copy, or concatenation occurred. Measured partial wall/GPU/cost through the last resource sample was 1,257.318 seconds / 0.349255 GPU-hours / CNY 3.101385. Backup SHA256: `498f0a33696cd3aed77a6d2e9f7fc02e1515fcf624f51aef023b5b12dcc65e21`.
- After new explicit authorization, fresh run `ppo_final_formal_1p5b_seed42_20260721T022152Z` completed 800/800 candidates and 98,018 exact tokens using only the fixed step-32 policy adapter. No training, resume, backward, optimizer, baseline rerun, GRPO, or seed-123 evaluation ran.
- Final sampled pass@1 is 15/400 (3.75%); independent-pool pass@4 is 9/100 (9.0%); greedy is null/unavailable. GSM8K is 2.5%/8.0%, MATH500 5.0%/10.0%; Level 1–5 pass@1 is 12.5%/10.0%/0%/2.5%/0%.
- Matching base deltas are -0.25 pp pass@1 and -1.0 pp pass@4. Pass@1 paired transitions are 8 improvements / 9 regressions / 7 both pass / 376 both fail; bootstrap 95% CI [-2.25,+1.75] pp. Pass@4 transitions are 2/3/7/88; CI [-5,+3] pp. These are descriptive and not tuning evidence.
