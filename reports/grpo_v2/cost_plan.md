...
## Stage O.3 evaluation amendment

The shared n=10 design uses 1,300 completions/model and 5,200/four models. Historical throughput projects 4,542.83 seconds / 1.261897 GPU-hours / CNY11.21 per model and 18,171.31 seconds / 5.047587 GPU-hours / CNY44.82 for four models. Conservative ceilings are 5,330.82 seconds / 1.480782 GPU-hours / CNY13.15 per model and 21,323.26 seconds / 5.923129 GPU-hours / CNY52.60 total. Versus O.2 it adds 1,200 completions (about CNY10.34 expected, CNY12.14 ceiling); versus independent pass@k pools it saves 2,000 completions (about CNY17.24 expected, CNY20.23 at the ceiling throughput). One n=10 call reduces repeated prompt tokenization/prefill and scheduling, but all candidates still require decode compute.
