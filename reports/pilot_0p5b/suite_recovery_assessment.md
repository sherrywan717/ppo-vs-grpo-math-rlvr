...
Current HEAD: `463881f49db5b43d5445cf7233e9e210b3d9b8f2` on `pivot/math-rlvr`.
...
|---:|---|---:|---|---|---|---:|---:|---|---|---|---|
| 1 | PPO | 42 | `ppo_matched_0p5b_seed42_20260716T114710Z` | yes | historical failure (before generation) | 0 | 0 | 0/0 | failure evidence | verified archive | `8db7ce6` |
...
The four protected historical PPO seed-42 failures remain excluded from any
aggregate. The seed-123 PPO evidence is complete: four batch-4 backward events,
